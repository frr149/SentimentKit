#!/usr/bin/env python3
"""
Extract golden messages from cardiffnlp/tweet_sentiment_multilingual.
Processes ALL candidates and outputs fixtures ready for messages.json.
"""
...
# Languages: code -> {file_name, targets per category}
LANGUAGES = {
    "pt": {"file": "portuguese", "positive": 5, "frustration": 5, "profanity": 5},
    "de": {"file": "german", "positive": 5, "frustration": 5, "profanity": 5},
    "fr": {"file": "french", "positive": 5, "frustration": 5, "profanity": 5},
    "zh": {"file": "chinese", "positive": 5, "frustration": 5, "profanity": 5},
}
...
def process_language(lang_code, info):
    ...
    for i, tweet in enumerate(tweets):
        ...
        # Skip if too many matches (ambiguous)
...
def main():
    ...
    # Output as JSON
    with open("/tmp/new_golden_fixtures.json", "w") as f:
        json.dump(all_fixtures, f, indent=2, ensure_ascii=False)

    print(f"\nSaved to /tmp/new_golden_fixtures.json")
