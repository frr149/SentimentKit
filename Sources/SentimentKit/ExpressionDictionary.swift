...
public enum ExpressionDictionaryError: Error, Equatable, LocalizedError {
    ...
    public var errorDescription: String? {
        ...
        case let .invalidMetadata(key, value):
        ...
        case let .duplicateExpression(expression):
...
public struct ExpressionDictionary: Sendable, Equatable {
    ...
    public init(language: String, type: ExpressionType, entries: [Entry]) throws {
        ...
        for entry in entries {
            ...
            guard normalizedExpression.isEmpty == false else {
                throw ExpressionDictionaryError.invalidEntry(line: 0, reason: "expression must not be empty")
            }
    ...
    private static func parse(_ contents: String) throws -> (language: String, type: ExpressionType, entries: [Entry]) {
        var language: String?
