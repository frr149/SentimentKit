...
public struct OpenAISentimentScorer: SentimentScorer, Sendable {
    ...
    public func meanScore(for messages: [String], baseAnalysis: SessionAnalysis) async throws -> Double {
...
private struct OpenAIRequest: Encodable {
    ...
    func encode(to encoder: Encoder) throws {
        ...
        var propertiesContainer = schemaContainer.nestedContainer(keyedBy: PropertyKeys.self, forKey: .properties)
        var meanScoreContainer = propertiesContainer.nestedContainer(keyedBy: NumberSchemaKeys.self, forKey: .meanScore)
